(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider")) new Swiper(".main-slider__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    if (filterTitle) {
        ...
        filterTitle.addEventListener("click", (function() {
            ...
            if (filterContent.style.display === "none") filterContent.style.display = "block"; else filterContent.style.display = "none";
        }));
    }
    window["FLS"] = true;
    isWebp();
